...
<s:layout-render name="/layout.jsp" titlekey="category.list.title">
    <s:layout-component name="body">
        ...
        <c:set var="numberOfCategories" scope="session" value="${actionBean.categories}"/>

        <div class="menu_container">
        <button type='button' class="button dialog_button bigtext"><f:message key="category.create"/></button>
        </div>
        <br>
        <div class="table_container">
            <table class="basic">
                ...
                <c:choose>
                    <c:when test="${empty numberOfCategories}">
        ...
        <div id="add" title="Add the category">
                <s:form beanclass="cz.muni.fi.pa165.legomanager.web.CategoryActionBean">
