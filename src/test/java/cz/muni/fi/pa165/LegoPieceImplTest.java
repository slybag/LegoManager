...
import cz.muni.fi.pa165.legomanager.entity.LegoPiece.PetColor;
...
public class LegoPieceImplTest extends BaseTest {
    ...
    public void addLegoPieceTest() {
        LegoPiece legoPiece1 = createLegoPiece(PetColor.RED);
        try {
    ...
    public void getAllLegoPiecesTest() {
        ...
        LegoPiece piece1 = createLegoPiece(PetColor.RED);
        LegoPiece piece2 = createLegoPiece(PetColor.GREEN);
        LegoPiece piece3 = createLegoPiece(PetColor.BLUE);
    ...
    public void updateLegoPieceTest() {
        ...
        legoPiece1.setColor(PetColor.PURPLE);
        try{
            legoPieceDao.updateLegoPiece(legoPiece1);
            LegoPiece updated = legoPieceDao.findLegoPieceById(legoPiece1.getId());
            assertEquals(updated.getColor(), PetColor.PURPLE);
        } catch (Exception ex){
            fail("No exception");
        }
    }
    ...
    private LegoPiece createLegoPiece(PetColor color) {
